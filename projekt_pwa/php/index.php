...
<?php
    ...
    ?>
    <section>
        <h3 class="news_scope">U.S</h3>
        <div class="container">
            <div class="row">
                <?php
                
                include 'connect.php';
                $query="SELECT * FROM vijest WHERE kategorija='U.S' && arhiva=0";
        ...
        <h3 class="news_scope">World</h3>
        <div class="container">
            <div class="row">
            <?php
                
                include 'connect.php';
                $query="SELECT * FROM vijest WHERE kategorija='World' && arhiva=0";
                $result=mysqli_query($dbc,$query);
                while($row=mysqli_fetch_array($result))
                {
                   echo "<div class='col-lg-4 col-md-6'>";
